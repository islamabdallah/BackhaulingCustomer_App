...
import 'package:customerapp/features/trips/data/models/trip.dart';
import 'package:customerapp/features/trips/data/models/trips.dart';
import 'package:customerapp/features/trips/presentation/bloc/trip-bloc.dart';
...
//    pointsLatLng.add(_lastMapPosition);
  ...
  getUserLocation() async {
    ...
    final _bitmapDescriptorGreen = await MarkerGenerator(120)
        .createBitmapDescriptorFromIconData(Icons.local_shipping, Colors.green, Colors.transparent, Colors.transparent);
    final _bitmapDescriptorRed = await MarkerGenerator(120)
